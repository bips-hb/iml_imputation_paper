...
coverage_mean <- rbind(coverage_pfi, coverage_pdp)#coverage_shap #rbind(coverage_pfi, coverage_pdp, coverage_shap)
...
#ggsave("plots_presentation/coverage_xgb_MAR_04_SHAP.pdf", width = 210, height = 80, units = "mm", scale = 2) 
ggsave("plots_presentation/coverage_xgb_MAR_04_PFI_PD.pdf", width = 210, height = 140, units = "mm", scale = 2) 
...
width_mean <- width_shap_mean #rbind(width_pfi_mean, width_pdp_mean)#, width_shap_mean)
...
#ggsave("plots_presentation/width_xgb_MAR_SHAP.pdf", width = 210, height = 120, units = "mm", scale = 2)
ggsave("plots_presentation/width_xgb_MAR_04_SHAP.pdf", width = 210, height = 80, units = "mm", scale = 2) 
#ggsave("plots_presentation/width_xgb_MAR_04_PFI_PD.pdf", width = 210, height = 140, units = "mm", scale = 2) 
...
#ggsave("plots_presentation/bias_xgb_MAR_SHAP.pdf", width = 210, height = 120, units = "mm", scale = 2)
#ggsave("plots_presentation/bias_xgb_MAR_04_SHAP.pdf", width = 210, height = 80, units = "mm", scale = 2) 
ggsave("plots_presentation/bias_xgb_MAR_04_PFI_PD.pdf", width = 210, height = 140, units = "mm", scale = 2) 
